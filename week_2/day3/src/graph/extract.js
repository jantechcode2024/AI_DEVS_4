...
const ENTITY_TYPES = new Set(["power supply", "cooling", "water pumps", "software", "other power plant components", "other"]);
...
{
  "entities": [
    { "category": "Category (CRIT etc.)", "type": "power supply"|"cooling"| "water pumps"|"software"|"other power plant components"|"other", "description": "One-sentence description" }
  ],
  "relationships": [
