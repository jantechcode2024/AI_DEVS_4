...
const TOOLS = [
  // ── Retrieval ────────────────────────────────────────────────
  {
    ...
    name: "search",
    description:
      "Search through the logs in format  base using hybrid retrieval (full-text BM25 + semantic vector). " +
      "Returns matching document chunks AND the graph entities mentioned in those chunks. Example log could be: [2026-03-18 15:28:37] [INFO] Power bus handshake confirmed on PWR01. Input phase balance remains stable." +
      "Use this as your first tool for any question — it gives you both text evidence and entity handles " +
      "you can pass to 'explore' or 'connect' for deeper graph traversal. You should return result chunks in format [YYYY-MM-DD] [CATEGORY] chunk message",
    parameters: {
      type: "object",
      properties: {
        keywords: {
