export const tools = [
  ...
  If action requires no extra params, pass params="{}"`,
...

    {
        type: "function",
        name: "configure",
        description: `Configure wind turbine with scheduled configurations.
        'configs' is an object where keys are datetime strings (YYYY-MM-DD HH:MM:SS) and values are configuration objects containing pitchAngle, turbineMode, and unlockCode.`,
        parameters: {
            type: "object",
            properties: {
                configs: {
                    type: "object",
                    description: "Object where keys are datetime strings (YYYY-MM-DD HH:MM:SS) and values are configuration objects. Each value has pitchAngle (number), turbineMode (string: 'production' or 'idle'), and unlockCode (string)."
                }
            },
            required: ["configs"],
            additionalProperties: false,
